...
.VPSidebarItem.level-6.is-active > .item > .indicator {
...
.VPSidebarItem.level-6.is-link > .item > .link:hover .text {
...
.VPSidebarItem.level-6.has-active > .item > .text,
...
.VPSidebarItem.level-6.has-active > .item > .link > .text {
  color: var(--vp-c-text-1);
}
...
.VPSidebarItem.level-6.is-active > .item .link > .text {
  color: var(--vp-c-brand-1);
}
