...
| Menu | What it's for |
|------|----------------|
| [Orders](/api/graphql-api/admin/sales/orders/) | Browse orders and run every per-order action — view, reorder, place, cancel, comment, and generate invoices / shipments / refunds. |
| [Carts](/api/graphql-api/admin/sales/carts/) | The admin draft-cart used to build a new order from the admin side (Create Order). |
...
| [Transactions](/api/graphql-api/admin/sales/transactions/) | Payment transactions recorded against orders and invoices. |
