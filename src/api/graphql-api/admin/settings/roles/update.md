...
examples:
  - id: gql
    ...
    variables: |
      { "input": { "id": "/api/admin/settings/roles/3", "name": "Catalog Manager+", "description": "Updated", "permissionType": "custom", "permissions": ["catalog.products.view", "catalog.products.edit"] } }
    response: |
