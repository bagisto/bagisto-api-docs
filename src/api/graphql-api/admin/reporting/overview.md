...
| Arg | Type | Notes |
|-----|------|-------|
| `type` | String | `total-sales` (default), `total-orders`, `total-customers`, `top-selling-products-by-revenue`. |
| `start` | String | Start of the reporting window (`YYYY-MM-DD`). |
| `end` | String | End of the reporting window (`YYYY-MM-DD`). |
