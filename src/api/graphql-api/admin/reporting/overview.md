...
examples:
  ...
  - id: gql-overview-total-customers
  ...
  - id: gql-overview-top-selling-products-by-revenue
...
- [Reporting — Overview (REST)](/api/rest-api/admin/reporting/overview) — same data over `GET /api/admin/reporting/stats`.
- [Dashboard Statistics](/api/graphql-api/admin/dashboard/stats) — the headline cards behind the admin Dashboard screen.
