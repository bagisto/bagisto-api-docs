...
examples:
  - id: rest
    ...
    query: |
      curl -X POST "https://your-domain.com/api/admin/settings/inventory-sources/mass-delete" -H "X-Admin-Key: <key>" -H "Authorization: Bearer <token>" -H "Content-Type: application/json" -d '{ "indices": [3, 4] }'
    response: |
