...
| Action | Endpoint |
|--------|----------|
| [List Requests](./list.md) | `GET /api/admin/customers/gdpr-requests` |
| [Request Detail](./detail.md) | `GET /api/admin/customers/gdpr-requests/{id}` |
| [Update Request](./update.md) | `PUT /api/admin/customers/gdpr-requests/{id}` |
| [Process (Approve + Execute)](./process.md) | `POST /api/admin/customers/gdpr-requests/{id}/process` |
| [Delete Request](./delete.md) | `DELETE /api/admin/customers/gdpr-requests/{id}` |
