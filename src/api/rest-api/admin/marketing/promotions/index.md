...
|----------|----------------|
| [Catalog Rules](/api/rest-api/admin/marketing/promotions/catalog-rules/) | Automatic product-price reductions applied store-wide before checkout. |
| [Cart Rules](/api/rest-api/admin/marketing/promotions/cart-rules/) | Discounts applied to the cart at checkout, optionally coupon-gated. |
| [Cart Rule Coupons](/api/rest-api/admin/marketing/promotions/cart-rule-coupons/) | The coupon codes (single or bulk-generated) that activate a coupon-driven cart rule. |
...
All Promotions endpoints require an admin Bearer token — see [Authentication](/api/rest-api/admin/authentication).
